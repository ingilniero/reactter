...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsTweetBox = __webpack_require__(1);

	var _componentsTweetBox2 = _interopRequireDefault(_componentsTweetBox);

	var _componentsTweetList = __webpack_require__(2);
	  ...
	  _createClass(Home, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      $.ajax('/tweets').success(function (data) {
	        return _this.setState({ tweetsList: data });
	...
	var documentReady = function documentReady() {
	  var reactNode = document.getElementById('home');
	  if (reactNode) {
	    ReactDOM.render(React.createElement(Home, null), reactNode);
	  }
	};
	  ...
	  _createClass(TweetList, [{
	    ...
	    value: function render() {
	      var tweets = this.props.tweets.map(function (tweet) {
	        return React.createElement(_Tweet2['default'], _extends({}, tweet, { key: tweet.id }));
	      });
	      return React.createElement(
	        'div',
	        null,
